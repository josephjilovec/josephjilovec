...
const moments = [
  ...
  { year: "Systems", title: "Technical work becomes a second language", copy: "Open-source projects, data work, AI workflows, robotics concepts, and architecture studies became tools for translating ideas into buildable requirements." },
