    ...
    <>
      ...
      <section className="section evidence-section">
        <SectionHeading index="03" eyebrow="Operating evidence" title="Credibility comes from specifics.">
          <p>The portfolio is intentionally careful about the difference between past operating experience, current experiments, public-interest initiatives, and future possibilities.</p>
        </SectionHeading>
