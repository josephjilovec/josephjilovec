...
export default function ContactPage() {
  return (
    <>
      <section className="page-hero contact-hero"><div><p className="hero-kicker">Contact / opportunity routing</p><h1>Tell me what got your attention!<span>leverage.</span></h1></div><p>Operating leadership, capital partnerships, technical collaboration, distribution, civic and nonprofit relationships, media, creative work, and focused project questions can all start here.</p></section>
