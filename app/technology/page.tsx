...
export default function TechnologyPage() {
  ...
  return (
    <>
      ...
      <section className="link-band"><div><span>Technology portfolio</span><h2>Explore the current systems concepts in context.</h2></div><a className="button" href="/ventures">View venture universe ↗</a></section>
    </>
  );
}
