...
`public/project-art/hotwax.svg`
- Replace with: approved album artwork, studio photography, release stills, or motion loops from the DJ Hotwax identity.
...
Recommended next asset: 1200×630 PNG/JPG with Joseph portrait + studio wordmark + venture constellation. Add it to metadata once approved.
